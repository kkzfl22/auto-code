...
// */
// public class JavaCodeJunitServiceCreate extends TableProcessBase implements AutoCodeInf {
//
//    public static void main(String[] args) throws Exception {
//        JavaCodeJunitServiceCreate instance = new JavaCodeJunitServiceCreate();
//
//        args = new String[3];
//
//        args[0] = "D:/java/encode/a10/javaMapJunitService/";
//        args[1] = "com.a10.resource.phone.";
//        args[2] = "a10";
//
//        instance.enTestServiceCode(args[0], args[1], args[2]);
//    }
//
//    private void enTestServiceCode(String path, String basePackageStr, String tableSpace) throws
// Exception {
//
...
//            sb.append("*").append(tableName.getKey()).append("表的业务操作单元测试").append(NEXT_LINE);
...
//
//            // 添加前置方法
//            sb.append(formatMsg(1)).append("private " + tableClassName + "Service serviceDao;" +
// NEXT_LINE);
//
//            sb.append(formatMsg(1)).append(" @Before" + NEXT_LINE);
//            sb.append(formatMsg(1)).append("public void setBean() { " + NEXT_LINE);
//            sb.append(formatMsg(2)).append("serviceDao = (" + tableClassName + "Service)");
//            sb.append(" this.getBean(\"" + getSpringInstanceName(tableClassName) +
// "ServiceImpl\"); " + NEXT_LINE);
//            sb.append(formatMsg(1)).append("}" + NEXT_LINE);
//            sb.append(NEXT_LINE);
//
//            // 添加insert方法
//            sb.append(formatMsg(1)).append("@Test" + NEXT_LINE);
//            sb.append(formatMsg(1)).append("public void testInsert()  {");
//            sb.append(NEXT_LINE);
...
//            }
//            // 执行添加代码操作
//            sb.append(formatMsg(2)).append("boolean rs = serviceDao.insert(map);" + NEXT_LINE);
...
//            // 修改
//            sb.append(formatMsg(1)).append("@Test" + NEXT_LINE);
//            sb.append(formatMsg(1)).append("public void testUpdate()  {");
//            sb.append(NEXT_LINE);
...
//                sb.append("\");" + NEXT_LINE);
//            }
//            sb.append(formatMsg(2)).append("boolean rs = serviceDao.update(updatemap);" +
// NEXT_LINE);
//            sb.append(formatMsg(2)).append("System.out.println(rs);" + NEXT_LINE);
//            sb.append(formatMsg(1)).append("}");
//
...
//            // 删除
//            sb.append(formatMsg(1)).append("@Test" + NEXT_LINE);
//            sb.append(formatMsg(1)).append("public void testDelete()  {");
//            sb.append(NEXT_LINE);
...
//            sb.append("\");");
//            sb.append(NEXT_LINE);
//            sb.append(formatMsg(2)).append("boolean rs = serviceDao.delete(deleteMap);" +
// NEXT_LINE);
//            sb.append(formatMsg(2)).append("System.out.println(rs);" + NEXT_LINE);
//            sb.append(formatMsg(1)).append("}");
//            sb.append(NEXT_LINE);
...
//            // 查询
//            sb.append(formatMsg(1)).append("@Test" + NEXT_LINE);
//            sb.append(formatMsg(1)).append("public void testQuery() {");
//            sb.append(NEXT_LINE);
...
// serviceDao.query(queryMap);" + NEXT_LINE);
//            sb.append(formatMsg(2)).append("System.out.println(rs);" + NEXT_LINE);
//            sb.append(formatMsg(1)).append("}");
//
//            sb.append(NEXT_LINE);
...
//                    .append("Pagination<Map<String,Object> rs =
// serviceDao.queryPage(queryMap,1,1);" + NEXT_LINE);
//            sb.append(formatMsg(2)).append("System.out.println(rs);" + NEXT_LINE);
//            sb.append(formatMsg(1)).append("}");
//            sb.append(NEXT_LINE);
//            // 结束
...
//        // 进行自动代码生成
//        try {
//            String daoInfPath = param.getFileBasePath() + "javaMapJunitService/";
//            String javaPackage = param.getJavaPackage();
//            this.enTestServiceCode(daoInfPath, javaPackage, param.getTableSpaceName());
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//
