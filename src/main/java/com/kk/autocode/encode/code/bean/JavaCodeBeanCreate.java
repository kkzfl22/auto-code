 ...
 */
public class JavaCodeBeanCreate extends TableProcessBase implements AutoCodeInf {
  ...
  private void encodeServiceImpl(
    ...
    while (tableNameEntry.hasNext()) {
      ...
      sb.append("package ").append(basePackageStr).append("dto").append(";").append(NEXT_LINE);
      sb.append(NEXT_LINE);
      sb.append(NEXT_LINE);
  ...
  public void autoCode(CreateParamBean param) {
    // 进行自动代码生成
    try {
      String daoInfPath = param.getFileBasePath() + "javaBean/";
