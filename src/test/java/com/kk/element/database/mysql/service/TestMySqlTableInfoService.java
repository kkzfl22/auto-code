...
public class TestMySqlTableInfoService {

  /** 查询所有表的相关信息 */
  @Test
  public void test01SelectAllTableInfo() {
    List<TableInfoDTO> list = MySqlTableInfoService.INSTANCE.selectAllTable("autocode");
