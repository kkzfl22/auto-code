...
import com.kk.readExcel.service.tosql.service.beantosqlstr.valueProc.AssertTypeColumnProcImpl;
 ...
 * @author liujun
 */
public class ExcelToSqlBuilder {
	 ...
	 * 进行数据列处理
	 */
	private DataColumnProcInf columnProc = new AssertTypeColumnProcImpl();
	 ...
	 *            小文件
	 */
	public void readelExceltoSql(String inputFileName, int maxLength, String outputFileName,int sheetNum) {
		// 1，读取excel信息,得到数据源信息
		TableInfoBean excelSrc = getTableData(inputFileName, sheetNum);
