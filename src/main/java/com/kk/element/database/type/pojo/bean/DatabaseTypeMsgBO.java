package com.kk.element.database.type.pojo.bean;

import com.kk.element.common.constant.SysSpitSymbolEnum;
import com.kk.element.database.type.constant.DatabaseDefValueEnum;
import com.kk.element.database.type.constant.DatabaseTypeSourceEnum;
import com.kk.element.database.type.constant.ParseJavaTypeLength;
...
public class DatabaseTypeMsgBO {
  ...
  public static DatabaseTypeMsgBO Parse(String key, String proValue) {
    ...
    if (proValue.indexOf(ParseJavaTypeLength.UNION_FLAG) != -1) {
      String[] provalues = proValue.split(SysSpitSymbolEnum.CAMMA.getSymbol());
